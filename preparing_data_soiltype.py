...
arcpy.AddMessage("Minumun Dem uluşturuluyor")
dem_mean=BlockStatistics(dem,NbrRectangle(6,6,"CELL"),"MEAN")
dem_mean.save(ws+"\dem_mean")
arcpy.AddMessage("Mean Dem uluşturuluyor")

arcpy.AddMessage("RG dosyası oluşturuluyor")
roughness=dem_mean-dem_min
roughness.save(ws+"/rg.tif")

arcpy.AddMessage("Sınıflandırma dosyası oluşturuluyor")
...
##Soil tiplerini ayrı ayrı bölüyor
...
arcpy.AddMessage("Zemin tipleri ayrı ayrı kaydediliyor")
...
arcpy.AddField_management(rocks,"density","LONG")
arcpy.CalculateField_management(rocks,"NID",expression,"PYTHON",block)
arcpy.CalculateField_management(rocks,"density",density,"PYTHON")
...
arcpy.env.cellSize = cellsize
arcpy.RasterToASCII_conversion(dem,"dem.txt")
